                ...
                <div className="columns is-multiline is-mobile">
                    <div className="column is-12">
                        <div className="block has-text-centered">
                            Welcome to <strong>TraderBuddy</strong>! <strong>TraderBuddy</strong> aims to provide
                            ...
                            making. <strong>TraderBuddy</strong> aims to track your performance for each
                        ...
                        <BaseCard
                            ...
                            content={[
                                <>
                                    ...
                                    <br/>
                                    <p className="has-text-justified">
                                        Connect your trading account to TraderBuddy and use your trading performance to
                    ...
                    <div className="column is-12">
                        <hr className="is-primary"/>
                        <div className="block has-text-centered">
                            <strong>TraderBuddy</strong> is all about growth. A great trader is not born but rather
                            created through
                            hard-work, determination, tenacity and a willingness to learn from one's mistakes. A great
                            trader is created
                            through growth in all of these concepts and <strong>TraderBuddy</strong>'s purpose is to
                            provide a service
